...
const FT_WIN_URL = 'https://storage.googleapis.com/flutter_infra/releases/stable/windows/flutter_windows_2.0.1-stable.zip'
...
download(FT_WIN_URL, path.resolve(__dirname, '../', 'sdk'), changeName('flutter'))
